...
export function ExperienceMatchCard({
  ...
  return (
    <article
      ...
      data-state="default"
      className={cn(
        'flex w-full flex-col gap-2.5 rounded-xl border border-border-default bg-background-w px-4 py-5',
        className,
      )}
      {...props}
    >
      <section className="flex w-full flex-col gap-2">
        <section className="flex w-full flex-col gap-3">
          <header className="flex w-full items-center gap-1">
            ...
            <section className="flex min-w-0 flex-1 flex-col gap-0.5">
              <h3 className="line-clamp-1 title-1-bold text-strong">{title}</h3>
